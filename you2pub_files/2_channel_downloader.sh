...
# Gestiona la descarga de los videos de un Canal de YouTube.
# ===============================================
...
DOWNLOAD_ARCHIVE_NAME="downloaded_video_ids.txt" # Nombre del archivo de registro de descargas
...
echo -e "\n${YELLOW}=== Paso A: Configuración de la carpeta principal (Canal)... ===${NC}"
...
# 4. Determinar el nombre final de la carpeta (Carpeta principal del canal)
...
# 6. Cambiar el directorio (cd) a la carpeta principal del canal
...
# NOTA: yt-dlp ignorará automáticamente los videos ya presentes en downloaded_video_ids.txt
# cuando se ejecute el comando principal más abajo.
...
# ----------------------------------------------------------------------------------
# 🔑 PASO C: Iteración Controlada y Descarga por ID (Idéntico a tu script de Playlist)
# ----------------------------------------------------------------------------------
PROCESSED_COUNT=0
...
echo -e "\n${GREEN}===================================================================${NC}"
echo -e "${GREEN} 🎉 Proceso de descarga de $TOTAL_VIDEOS videos del Canal completado. ${NC}"
echo -e "${GREEN}===================================================================${NC}"
