...
JS_ROOT="generate_root.js" 
JS_CHANNEL="generate_channel.js"
JS_VIDEO="generate_video.js"
...
# 0.5. Generar Datos del Menú (Crea Videos/js/menu_data.js)
echo "0.5. Generando datos del Menú ($ROOT_DIR/js/menu_data.js)..."
deno run --allow-read --allow-write generate_menu.ts "$ROOT_DIR"
if [ $? -ne 0 ]; then
...
deno run --allow-write generate_css.js "$ROOT_DIR"
if [ $? -ne 0 ]; then
